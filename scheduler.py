...
def scheduler():
    ...
    sched.add_job(lambda: sd.StockData.update_5m_price_history(only_last_hour=False), trigger= update_5m_data_daily_trigger, name = "Update 5m price history", timezone=timezone, replace_existing=True)
