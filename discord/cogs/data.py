    ...
    async def csv(self, interaction: discord.Interaction, tickers: str, frequency: app_commands.Choice[str]):
        ...
        try:
            ...
            if len(invalid_tickers) > 0:
                ...
                await interaction.followup.send("Fetched data files for [{}]({}). Invalid tickers:".format(", ".join(invalid_tickers)), ephemeral=True)
            else:
    ...
    async def popularity(self, interaction: discord.Interaction, tickers: str):
        ...
        try:
            ...
            if len(invalid_tickers) > 0:
                ...
                await interaction.followup.send("Fetched popularity for [{}]({}). Invalid tickers:".format(", ".join(invalid_tickers)), ephemeral=True)
            else:
